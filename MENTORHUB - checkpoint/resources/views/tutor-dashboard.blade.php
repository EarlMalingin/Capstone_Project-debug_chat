...
<body>
    ...
    <main>
        ...
        <div class="quick-actions">
            <div class="action-card" onclick="createSession()">
            ...
            <div class="action-card">
                <a href="{{ route('tutor.messages') }}" style="text-decoration: none; color: inherit; display: flex; flex-direction: column; align-items: center; width: 100%; height: 100%;">
                    <div class="action-icon">💬</div>
                    <div>Messages</div>
                </a>
            </div>
